...
class PreparatoryWorksRelationManager extends RelationManager
{
    protected static string $relationship = 'preparatory_works';

    protected static ?string $recordTitleAttribute = 'work';

    protected static ?string $title = 'Persiapan Pekerjaan';

    protected static ?string $modelLabel = 'Persiapan Pekerjaan';

    protected static ?string $pluralModelLabel = 'Persiapan Pekerjaan';
